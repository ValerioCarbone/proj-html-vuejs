...
export default {
    ...
    computed: {
        servicesCards() {
            return this.database.serviceCards
        }
    }
}
</script>
...
<template>
    <div class="row">
        <div class="section-content">
            <img src="/icon-6.png" class="icon">
            <div class="title-container">
                <h2 class="title dark-blue">Our Health Services</h2>
            </div>
        ...
        <div class="cards">
            <introCard v-for="(card, index) in servicesCards" :key="index" :card="card" class="col-4" />
        </div>
    </div>
</template>
